...
DROP TABLE COUPON_EVENT CASCADE CONSTRAINTS;
...
CREATE TABLE COUPON_EVENT(
    COUPON_EVENT_ID NUMBER NOT NULL,
    QUANTITY NUMBER NOT NULL,
...
-- foreign key
ALTER TABLE Coupon ADD FOREIGN KEY (COUPON_EVENT_ID) REFERENCES COUPON_EVENT(COUPON_EVENT_ID);
