        ...
        <div className={styles.categoryList}>
          <Card className={styles.categoryItem}>
            <div className={styles.CardCenter}>
              <Link to={`/stores?category=${categorys[0]}`}>
          ...
          <Card className={styles.categoryItem}>
            <div className={styles.CardCenter}>
              <Link to={`/stores?category=${categorys[1]}`}>
          ...
          <Card className={styles.categoryItem}>
            <div className={styles.CardCenter}>
              <Link to={`/stores?category=${categorys[2]}`}>
          ...
          <Card className={styles.categoryItem}>
            <div className={styles.CardCenter}>
              <Link to={`/stores?category=${categorys[3]}`}>
          ...
          <Card className={styles.categoryItem}>
            <div className={styles.CardCenter}>
              <Link to={`/stores?category=${categorys[6]}`}>
          ...
          <Card className={styles.categoryItem}>
            <div className={styles.CardCenter}>
              <Link to={`/stores?category=${categorys[7]}`}>
          ...
          <Card className={styles.categoryItem}>
            <div className={styles.CardCenter}>
              <Link to={`/stores?category=${categorys[8]}`}>
          ...
          <Card className={styles.categoryItem}>
            <div className={styles.CardCenter}>
              <Link to={`/stores?category=${categorys[9]}`}>
