...
function MyPage() {
  ...
  return (
    <Container className={styles.container}>
        ...
        <input id="id" className={styles.inputbox} value="user"readOnly
            ></input>
        <h3 className={styles.subtitle}>학과명</h3>
        <input id="department" className={styles.inputbox} value="컴퓨터학부"readOnly
            ></input>
        <h3 className={styles.subtitle}>전화번호</h3>
        <input id="phone" className={styles.inputbox} value="010-123-456"readOnly
            ></input>
