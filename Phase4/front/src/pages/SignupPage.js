...
function SignupPage() {
  ...
  return (
    <Container className={styles.container}>
        ...
        <form>
            <input id="userid"className={styles.inputbox}
            placeholder="아이디를 입력하세요"
            ></input>
            <h3 className={styles.subtitle}>비밀번호</h3>
            <input id="password" className={styles.inputbox}
            placeholder="비밀번호를 입력하세요"
            ></input>
            <h3 className={styles.subtitle}>비밀번호 확인</h3>
            <input id="passwordCheck" className={styles.inputbox}
            placeholder="비밀번호를 입력하세요"
            ></input>
            ...
            <input id="phone" className={styles.inputbox}
            placeholder="전화번호를 입력하세요"
            ></input>
        </form>
        <div className={styles.link}>
            <Button id="signup" onClick={SignupException} as="div">회원가입</Button>
        </div>
    </Container>
  );
}
